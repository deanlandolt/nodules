(function(global){
var runInThisContext = typeof process === "object" && process.compile;
// try to get non-deprecated compile for node >= 0.3
if (runInThisContext) {
    try {
...
var compile = runInThisContext ?
	function(source, name){
		return runInThisContext("(" + source + ")", name);
	} :
